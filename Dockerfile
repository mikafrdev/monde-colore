...
ARG BETTER_AUTH_URL
ARG MEDIA_UPLOADS_PATH
ARG MEDIA_STATIC_PATH
...
ENV MEDIA_UPLOADS_PATH=$MEDIA_UPLOADS_PATH
ENV MEDIA_STATIC_PATH=$MEDIA_STATIC_PATH
...
# Créer le point de montage à l'avance, avec les bons droits
