...
export default async function Home() {
   ...
   return (
      <div className="aspect-3/2 max-md:aspect-864/1821 bg-size-[100%_auto] bg-top bg-no-repeat bg-[url('/static/images/bg-hp-desktop.png')] max-md:bg-[url('/static/images/bg-hp-mobile.png')]">
